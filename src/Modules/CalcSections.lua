...
{ 1, "Crit", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Crits", data = {
	...
	{ label = "Crit Multiplier", notFlag = "attack", { format = "x {2:output:CritMultiplier}", 
		...
		{ label = "Player modifiers", modName = { "CritMultiplier", "NoCritMultiplier" }, cfg = "skill" }, 
	...
	{ label = "MH Crit Multiplier", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", { format = "x {2:output:MainHand.CritMultiplier}", 
		...
		{ label = "Player modifiers", modName = { "CritMultiplier", "NoCritMultiplier" }, cfg = "weapon1" }, 
		{ label = "Enemy modifiers", modName = "SelfCritMultiplier", enemy = true },
	}, },
	...
	{ label = "OH Crit Multiplier", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", { format = "x {2:output:OffHand.CritMultiplier}", 
		...
		{ label = "Player modifiers", modName = { "CritMultiplier", "NoCritMultiplier" }, cfg = "weapon2" }, 
		{ label = "Enemy modifiers", modName = "SelfCritMultiplier", enemy = true },
	}, },
...
{ 1, "Bleed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Bleed", data = {
	...
	{ label = "Chance to Bleed", { format = "{0:output:BleedChance}%", 
		...
		{ label = "Special Mods", modName = "AilmentsOnlyFromCrit" },
	}, },
	...
	{ label = "MH Eff. DoT Multi", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.BleedDotMulti", { format = "x {2:output:MainHand.BleedDotMulti}", { breakdown = "MainHand.BleedDotMulti" }, { modName = { "DotMultiplier", "PhysicalDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "bleed" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.BleedDotMulti", { format = "x {2:output:OffHand.BleedDotMulti}", { breakdown = "OffHand.BleedDotMulti" }, { modName = { "DotMultiplier", "PhysicalDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "OHbleed" }, }, },
...
{ 1, "Poison", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Poison", data = {
	...
	{ label = "Eff. DoT Multi", notFlag = "attack", haveOutput = "PoisonDotMulti", { format = "x {2:output:PoisonDotMulti}", { breakdown = "PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "poison" }, }, },
	{ label = "MH Eff. DoT Multi", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.PoisonDotMulti", { format = "x {2:output:MainHand.PoisonDotMulti}", { breakdown = "MainHand.PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "poison" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.PoisonDotMulti", { format = "x {2:output:OffHand.PoisonDotMulti}", { breakdown = "OffHand.PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "OHpoison" }, }, },
...
{ 1, "Ignite", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Ignite", data = {	
	...
	{ label = "Eff. DoT Multi", notFlag = "attack", haveOutput = "IgniteDotMulti", { format = "x {2:output:IgniteDotMulti}", { breakdown = "IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "ignite" }, }, },
	{ label = "MH Eff. DoT Multi", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.IgniteDotMulti", { format = "x {2:output:MainHand.IgniteDotMulti}", { breakdown = "MainHand.IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "ignite" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.IgniteDotMulti", { format = "x {2:output:OffHand.IgniteDotMulti}", { breakdown = "OffHand.IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier", "DotMultiplierIsCritMultiplier", "AilmentsAreNeverFromCrit" }, cfg = "OHignite" }, }, },
